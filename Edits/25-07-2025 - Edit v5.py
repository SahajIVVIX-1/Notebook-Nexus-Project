...
class JupyterLauncher(QWidget):
    ...
    COLOR_PRIMARY = "#000000"  # Black background
    COLOR_BORDER = "#30363d"
    COLOR_BORDER_WINDOW = "#FF0000" # Red border for the main window
    COLOR_TEXT = "#c9d1d9"
    ...
    def __init__(self):
        ...
        # The following line is removed to make the background solid black instead of transparent.
    ...
    def _setup_main_layout(self):
        """Initializes the main layout for a custom frameless window."""
    ...
    def _create_files_section(self):
        """Builds the directory contents list."""
        layout = QVBoxLayout()
        layout.setSpacing(8)
    ...
    def _apply_stylesheet(self):
        ...
        self.setStyleSheet(f"""
            #JupyterLauncher {{
                ...
                /* ===> CHANGE THIS VALUE <=== */
                border-radius: 8px; /* Try changing this to 15px or 25px */
            ...
            #titleBar {{
                ...
                /* You also need to round the top corners of the title bar to match */
                border-top-left-radius: 6px;  /* Change this to match the window's radius minus the border width */
                border-top-right-radius: 6px; /* Change this to match the window's radius minus the border width */
            }}
            #titleLabel {{
